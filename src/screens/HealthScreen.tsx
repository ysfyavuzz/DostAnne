...
const HealthScreen: React.FC = () => {
  ...
  const [appointments, setAppointments] = useState([
    ...
    },
    {
      ...
      date: '15.01.2024',
      time: '11:00',
      purpose: 'Doğum kontrolü',
      status: 'completed',
      location: 'Ankara Şehir Hastanesi',
      notes: 'İlk muayene yapıldı',
    },
  ]);
  ...
  const healthRecords = [
    ...
    },
    {
      ...
      date: '15.03.2024',
      doctor: 'Dr. Ayşe Yılmaz',
      diagnosis: 'Sağlıklı gelişim',
      notes: 'Büyüme gelişim normal seyrinde',
      weight: '5.8 kg',
      height: '58 cm',
    },
  ];
  ...
  const handleMarkVaccineGiven = (vaccineId: number) => {
    Alert.alert('Aşı Yapıldı', 'Aşı kaydı güncellenecek');
  };
    ...
    <View style={styles.vaccineCard}>
      ...
      {vaccine.status === 'upcoming' && (
        <TouchableOpacity 
          ...
          onPress={() => handleMarkVaccineGiven(vaccine.id)}
        >
